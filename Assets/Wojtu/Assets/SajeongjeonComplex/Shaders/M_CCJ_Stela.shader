Shader "Unreal/M_CCJ_Stela"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Stela_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Stela_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Stela_R", 2D ) = "white" {}
