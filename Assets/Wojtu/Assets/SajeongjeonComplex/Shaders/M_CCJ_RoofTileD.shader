Shader "Unreal/M_CCJ_RoofTileD"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofTileD_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofTileD_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofTileD_R", 2D ) = "white" {}
