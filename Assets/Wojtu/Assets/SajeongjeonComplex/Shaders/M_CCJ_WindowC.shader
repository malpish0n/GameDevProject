Shader "Unreal/M_CCJ_WindowC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_WindowC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_WindowC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_WindowC_R", 2D ) = "white" {}
