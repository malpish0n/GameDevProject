Shader "Unreal/M_MCJ_DoorFrameA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_DoorFrameA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_DoorFrameA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_DoorFrameA_R", 2D ) = "white" {}
