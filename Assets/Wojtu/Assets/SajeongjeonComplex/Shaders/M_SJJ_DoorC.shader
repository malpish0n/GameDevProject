Shader "Unreal/M_SJJ_DoorC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorC_R", 2D ) = "white" {}
