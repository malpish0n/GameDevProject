Shader "Unreal/M_SJJ_WindowB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_WindowB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_WindowB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_WindowB_R", 2D ) = "white" {}
