Shader "Unreal/M_CCJ_Judo"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Judo_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Judo_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Judo_R", 2D ) = "white" {}
