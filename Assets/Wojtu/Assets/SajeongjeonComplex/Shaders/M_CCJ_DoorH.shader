Shader "Unreal/M_CCJ_DoorH"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorH_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorH_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorH_R", 2D ) = "white" {}
