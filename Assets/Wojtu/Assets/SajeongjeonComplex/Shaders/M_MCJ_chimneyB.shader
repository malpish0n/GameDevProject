Shader "Unreal/M_MCJ_chimneyB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_ChimneyB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_chimneyB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_ChimneyB_R", 2D ) = "white" {}
