Shader "Unreal/M_SJJ_Inside_PartA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Inside_PartA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Inside_PartA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Inside_PartA_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_Inside_PartA.hlsl"
