Shader "Unreal/M_SJJ_InDoor_Iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_InDoor_Iron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_InDoor_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_InDoor_Iron_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_SJJ_InDoor_Iron_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_InDoor_Iron.hlsl"
