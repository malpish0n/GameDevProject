Shader "Unreal/M_MCJ_Door_Iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Door_Iron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Door_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Door_Iron_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_MCJ_Door_Iron_R", 2D ) = "white" {}
