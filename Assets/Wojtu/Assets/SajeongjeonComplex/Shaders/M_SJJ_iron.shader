Shader "Unreal/M_SJJ_iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Iron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Iron_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_SJJ_Iron_R", 2D ) = "white" {}
