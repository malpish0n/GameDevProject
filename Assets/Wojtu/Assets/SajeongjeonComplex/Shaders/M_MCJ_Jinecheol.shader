Shader "Unreal/M_MCJ_Jinecheol"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Jinecheol_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Jinecheol_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Jinecheol_R", 2D ) = "white" {}
