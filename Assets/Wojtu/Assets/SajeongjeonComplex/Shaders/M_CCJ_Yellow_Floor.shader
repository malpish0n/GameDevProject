Shader "Unreal/M_CCJ_Yellow_Floor"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Yellow_Floor_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Yellow_Floor_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Yellow_Floor_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_CCJ_Yellow_Floor.hlsl"
