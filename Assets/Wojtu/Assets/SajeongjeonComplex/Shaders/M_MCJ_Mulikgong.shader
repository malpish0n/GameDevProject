Shader "Unreal/M_MCJ_Mulikgong"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Mulikgong_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Mulikgong_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Mulikgong_R", 2D ) = "white" {}
