Shader "Unreal/M_MCJ_Stela"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Stela_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Stela_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Stela_R", 2D ) = "white" {}
