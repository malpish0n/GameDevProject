Shader "Unreal/M_CCJ_DoorE"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorE_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorE_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorE_R", 2D ) = "white" {}
