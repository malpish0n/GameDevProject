Shader "Unreal/M_CCJ_ChangBangB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_ChangBang_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_ChangBang_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_ChangBang_R", 2D ) = "white" {}
