Shader "Unreal/M_CCJ_RoofIron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofOrnament_Iron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofOrnament_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofOrnament_Iron_R", 2D ) = "white" {}
