Shader "Unreal/M_SJJ_RoofWallB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_RoofWallB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_RoofWallB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_RoofWallB_R", 2D ) = "white" {}
