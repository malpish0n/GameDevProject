Shader "Unreal/M_CCJ_Mulikgong"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Mulikgong_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Mulikgong_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Mulikgong_R", 2D ) = "white" {}
