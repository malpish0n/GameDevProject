Shader "Unreal/M_SJJ_Inner_ChangBang"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Inner_ChangBang_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Inner_ChangBang_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Inner_ChangBang_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_Inner_ChangBang.hlsl"
