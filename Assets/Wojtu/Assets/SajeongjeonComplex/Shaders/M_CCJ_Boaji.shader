Shader "Unreal/M_CCJ_Boaji"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Boaji_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Boaji_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Boaji_R", 2D ) = "white" {}
