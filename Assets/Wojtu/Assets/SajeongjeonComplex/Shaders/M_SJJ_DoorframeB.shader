Shader "Unreal/M_SJJ_DoorframeB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorframeB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorframeB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorframeB_R", 2D ) = "white" {}
