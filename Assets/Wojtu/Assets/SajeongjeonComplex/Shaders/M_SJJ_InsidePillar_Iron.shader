Shader "Unreal/M_SJJ_InsidePillar_Iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_InsidePillar_Iron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_InsidePillar_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_InsidePillar_Iron_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_InsidePillar_Iron.hlsl"
