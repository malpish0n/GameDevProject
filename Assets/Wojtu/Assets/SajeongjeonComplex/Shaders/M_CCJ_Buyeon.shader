Shader "Unreal/M_CCJ_Buyeon"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Buyeon_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Buyeon_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Buyeon_R", 2D ) = "white" {}
