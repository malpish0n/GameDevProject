Shader "Unreal/M_CCJ_ChimneyC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_ChimneyC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_ChimneyC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_ChimneyC_R", 2D ) = "white" {}
