Shader "Unreal/M_MCJ_WallC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_PatternWallC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_PatternWallC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_PatternWallC_R", 2D ) = "white" {}
