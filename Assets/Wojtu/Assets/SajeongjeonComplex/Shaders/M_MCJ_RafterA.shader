Shader "Unreal/M_MCJ_RafterA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RafterA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RafterA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_RafterA_R", 2D ) = "white" {}
