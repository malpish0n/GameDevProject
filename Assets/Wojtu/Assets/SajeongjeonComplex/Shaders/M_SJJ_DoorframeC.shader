Shader "Unreal/M_SJJ_DoorframeC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorframeC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorframeC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorframeC_R", 2D ) = "white" {}
