Shader "Unreal/M_MCJ_Gable"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Gable_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Gable_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Gable_R", 2D ) = "white" {}
