Shader "Unreal/M_MCJ_WindowA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_WindowA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_WindowA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_WindowA_R", 2D ) = "white" {}
