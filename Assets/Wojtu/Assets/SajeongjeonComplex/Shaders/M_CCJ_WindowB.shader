Shader "Unreal/M_CCJ_WindowB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_WindowB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_WindowB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_WindowB_R", 2D ) = "white" {}
