Shader "Unreal/M_CCJ_DoorFrameI"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorFrameI_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorFrameI_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorFrameI_R", 2D ) = "white" {}
