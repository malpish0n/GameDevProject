Shader "Unreal/M_SJJ_Buyeon"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Buyeon_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Buyeon_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Buyeon_R", 2D ) = "white" {}
