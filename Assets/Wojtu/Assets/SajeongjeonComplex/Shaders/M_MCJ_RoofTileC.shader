Shader "Unreal/M_MCJ_RoofTileC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RoofTileC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RoofTileC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_RoofTileC_R", 2D ) = "white" {}
