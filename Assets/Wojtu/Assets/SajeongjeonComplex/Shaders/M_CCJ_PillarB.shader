Shader "Unreal/M_CCJ_PillarB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_PillarB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_PillarB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_PillarB_R", 2D ) = "white" {}
