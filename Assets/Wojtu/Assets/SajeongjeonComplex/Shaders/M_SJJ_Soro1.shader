Shader "Unreal/M_SJJ_Soro1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Soro_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Soro_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Soro_R", 2D ) = "white" {}
