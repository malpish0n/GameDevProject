Shader "Unreal/M_SJJ_StairB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_StairB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_StairB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_StairB_R", 2D ) = "white" {}
