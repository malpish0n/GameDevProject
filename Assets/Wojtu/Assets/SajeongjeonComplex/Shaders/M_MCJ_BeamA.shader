Shader "Unreal/M_MCJ_BeamA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_BeamA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_BeamA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_BeamA_R", 2D ) = "white" {}
