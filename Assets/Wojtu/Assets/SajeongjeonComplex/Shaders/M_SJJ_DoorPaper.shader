Shader "Unreal/M_SJJ_DoorPaper"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorPaper_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorPaper_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorPaper_R", 2D ) = "white" {}
