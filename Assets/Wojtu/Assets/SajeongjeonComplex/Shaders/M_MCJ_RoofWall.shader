Shader "Unreal/M_MCJ_RoofWall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RoofWall_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RoofWall_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_RoofWall_Roughness", 2D ) = "white" {}
