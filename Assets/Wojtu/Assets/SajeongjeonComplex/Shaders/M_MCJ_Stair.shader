Shader "Unreal/M_MCJ_Stair"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Stair_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Stair_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Stair_R", 2D ) = "white" {}
