Shader "Unreal/M_CCJ_RoofInner"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofInner_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofInner_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofInner_R", 2D ) = "white" {}
