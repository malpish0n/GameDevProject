Shader "Unreal/M_CCJ_Wall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Wall_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Wall_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Wall_R", 2D ) = "white" {}
