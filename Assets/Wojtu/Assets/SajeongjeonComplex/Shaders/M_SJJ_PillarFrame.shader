Shader "Unreal/M_SJJ_PillarFrame"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_PillarFrame_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_PillarFrame_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_PillarFrame_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_PillarFrame.hlsl"
