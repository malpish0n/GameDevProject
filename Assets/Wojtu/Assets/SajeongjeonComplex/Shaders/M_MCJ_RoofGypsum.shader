Shader "Unreal/M_MCJ_RoofGypsum"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RoofGypsum_BC", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RoofGypsum_R", 2D ) = "white" {}
