Shader "Unreal/M_MCJ_BeamB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_BeamB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_BeamB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_BeamB_R", 2D ) = "white" {}
