Shader "Unreal/M_MCJ_Capital"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Capital_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Capital_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Capital_R", 2D ) = "white" {}
