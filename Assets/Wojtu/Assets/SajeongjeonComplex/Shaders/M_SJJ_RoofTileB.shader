Shader "Unreal/M_SJJ_RoofTileB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_RoofTileB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_RoofTileB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_RoofTileB_R", 2D ) = "white" {}
