Shader "Unreal/M_MCJ_ToenmaruA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_ToenmaruA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_ToenmaruA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_ToenmaruA_R", 2D ) = "white" {}
