Shader "Unreal/M_CCJ_GreenWood_Steel"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_GreenWood_Steel_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_GreenWood_Steel_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_GreenWood_Steel_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_CCJ_GreenWood_Steel_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_CCJ_GreenWood_Steel.hlsl"
