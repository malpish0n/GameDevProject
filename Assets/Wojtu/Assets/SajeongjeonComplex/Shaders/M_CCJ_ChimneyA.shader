Shader "Unreal/M_CCJ_ChimneyA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_ChimneyA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_ChimneyA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_ChimneyA_R", 2D ) = "white" {}
