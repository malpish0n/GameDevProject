Shader "Unreal/M_CCJ_RoofTileC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofTileC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofTileC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofTileC_R", 2D ) = "white" {}
