Shader "Unreal/M_SJJ_OutDoorHandle"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_OutDoorHandle_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_OutDoorHandle_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_OutDoorHandle_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_SJJ_OutDoorHandle_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_OutDoorHandle.hlsl"
