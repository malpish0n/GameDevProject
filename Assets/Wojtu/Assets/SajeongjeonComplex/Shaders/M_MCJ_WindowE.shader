Shader "Unreal/M_MCJ_WindowE"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_WindowE_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_WindowE_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_WindowE_R", 2D ) = "white" {}
