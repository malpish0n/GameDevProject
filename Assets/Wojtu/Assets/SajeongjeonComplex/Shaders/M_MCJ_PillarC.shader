Shader "Unreal/M_MCJ_PillarC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_PillarC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_PillarC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_PillarC_R", 2D ) = "white" {}
