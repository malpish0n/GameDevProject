Shader "Unreal/M_CCJ_DoorD"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorD_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorD_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorD_R", 2D ) = "white" {}
