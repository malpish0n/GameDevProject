Shader "Unreal/M_SJJ_CrossBeamA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_CrossBeamA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_CrossBeamA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_CrossBeamA_R", 2D ) = "white" {}
