Shader "Unreal/M_MCJ_DoorFrameB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_DoorFrameB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_DoorFrameB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_DoorFrameB_R", 2D ) = "white" {}
