Shader "Unreal/M_SM_SJJ_DoorB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorB_R", 2D ) = "white" {}
