Shader "Unreal/M_SJJ_DoorframeA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_DoorframeA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_DoorframeA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_DoorframeA_R", 2D ) = "white" {}
