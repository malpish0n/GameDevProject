Shader "Unreal/M_SJJ_GanpoOutside_shortA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_GanpoOutside_short_A_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_GanpoOutside_short_A_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_GanpoOutside_short_A_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_GanpoOutside_shortA.hlsl"
