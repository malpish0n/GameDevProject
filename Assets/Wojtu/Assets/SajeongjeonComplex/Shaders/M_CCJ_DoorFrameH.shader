Shader "Unreal/M_CCJ_DoorFrameH"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorFrameH_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorFrameH_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorFrameH_R", 2D ) = "white" {}
