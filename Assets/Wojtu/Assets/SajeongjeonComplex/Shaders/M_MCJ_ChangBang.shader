Shader "Unreal/M_MCJ_ChangBang"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_ChangBang_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_ChangBang_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_ChangBang_R", 2D ) = "white" {}
