Shader "Unreal/M_CCJ_StairC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_StairC_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_StairC_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_StairC_R", 2D ) = "white" {}
