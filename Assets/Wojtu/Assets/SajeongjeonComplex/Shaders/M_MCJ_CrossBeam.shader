Shader "Unreal/M_MCJ_CrossBeam"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_CrossBeam_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_CrossBeam_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_CrossBeam_R", 2D ) = "white" {}
