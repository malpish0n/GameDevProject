Shader "Unreal/M_CCJ_RoofWall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofWall_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofWall_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofWall_R", 2D ) = "white" {}
