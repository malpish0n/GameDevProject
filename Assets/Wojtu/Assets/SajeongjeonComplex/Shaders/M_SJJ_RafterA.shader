Shader "Unreal/M_SJJ_RafterA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_RafterA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_RafterA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_RafterA_R", 2D ) = "white" {}
