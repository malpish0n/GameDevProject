Shader "Unreal/M_CCJ_Jinecheol"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Jinecheol_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Jinecheol_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Jinecheol_R", 2D ) = "white" {}
