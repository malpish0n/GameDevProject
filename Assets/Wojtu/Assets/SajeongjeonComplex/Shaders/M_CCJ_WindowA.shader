Shader "Unreal/M_CCJ_WindowA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_WindowA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_WindowA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_WindowA_R", 2D ) = "white" {}
