Shader "Unreal/M_CCJ_Paper"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Paper_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Paper_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Paper_R", 2D ) = "white" {}
