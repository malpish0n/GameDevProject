Shader "Unreal/M_MCJ_RoofTileD"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RoofTileD_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RoofTileD_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_RoofTileD_R", 2D ) = "white" {}
