Shader "Unreal/M_SJJ_RoofRafter"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_RoofRafter_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_RoofRafter_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_RoofRafter_R", 2D ) = "white" {}
