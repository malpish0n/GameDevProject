Shader "Unreal/M_CCJ_RoofTileA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_RoofTileA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_RoofTileA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_RoofTileA_R", 2D ) = "white" {}
