Shader "Unreal/M_MCJ_GableIron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_GableIron_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_GableIron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_GableIron_R", 2D ) = "white" {}
