Shader "Unreal/M_SJJ_RoofWallA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_RoofWallA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_RoofWallA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_RoofWallA_R", 2D ) = "white" {}
