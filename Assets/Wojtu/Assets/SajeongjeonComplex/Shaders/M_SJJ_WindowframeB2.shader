Shader "Unreal/M_SJJ_WindowframeB2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_WindowframeB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_WindowframeB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_WindowframeB_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_WindowframeB2.hlsl"
