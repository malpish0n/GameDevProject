Shader "Unreal/M_MCJ_RoofInner"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_RoofInner_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_RoofInner_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_RoofInner_R", 2D ) = "white" {}
