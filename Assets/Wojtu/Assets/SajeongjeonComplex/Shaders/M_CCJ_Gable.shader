Shader "Unreal/M_CCJ_Gable"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Gable_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Gable_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Gable_R", 2D ) = "white" {}
