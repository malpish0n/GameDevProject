Shader "Unreal/M_CCJ_DoorFrameK"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorFrameK_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorFrameK_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorFrameK_R", 2D ) = "white" {}
