Shader "Unreal/M_MCJ_Celling"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_Celling_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_Celling_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_Celling_R", 2D ) = "white" {}
