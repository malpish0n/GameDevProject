Shader "Unreal/M_SJJ_SupportingBeamA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_SupportingBeamA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_SupportingBeamA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_SupportingBeamA_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_SupportingBeamA.hlsl"
