Shader "Unreal/M_CCJ_DoorFrameB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorFrameB_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorFrameB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorFrameB_R", 2D ) = "white" {}
