Shader "Unreal/M_MCJ_Wall03A_part"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MCJ_PatternWallA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MCJ_PatternWallA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_MCJ_PatternWallA_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_MCJ_Wall03A_part.hlsl"
