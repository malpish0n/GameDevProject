Shader "Unreal/M_CCJ_DoorG"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorG_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorG_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorG_R", 2D ) = "white" {}
