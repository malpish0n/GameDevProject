Shader "Unreal/M_CCJ_PatternWallD"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_PatternWallD_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_PatternWallD_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_PatternWallD_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_CCJ_PatternWallD.hlsl"
