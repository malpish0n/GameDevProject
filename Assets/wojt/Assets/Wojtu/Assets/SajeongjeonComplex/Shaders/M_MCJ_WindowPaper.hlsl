...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local4 = (Local2.r * 0.10000000);
	MaterialFloat Local5 = (Local2.g * 0.10000000);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = MaterialFloat3(MaterialFloat2(Local4,Local5),Local2.b);
	...
	MaterialFloat4 Local8 = ProcessMaterialVirtualColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,sampler_Material_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local11 = ProcessMaterialVirtualColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(MaterialFloat3(0.53125000,0.53125000,0.53125000).rgb,Material.PreshaderBuffer[2].x);
