...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local9 = ProcessMaterialVirtualColorTextureLookup(Texture2DSample(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local0)));
