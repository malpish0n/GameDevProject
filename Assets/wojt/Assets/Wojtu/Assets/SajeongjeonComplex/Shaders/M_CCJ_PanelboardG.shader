Shader "Unreal/M_CCJ_PanelboardG"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_PanelboardG_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_PanelboardG_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_PanelboardG_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_CCJ_PanelboardG.hlsl"
