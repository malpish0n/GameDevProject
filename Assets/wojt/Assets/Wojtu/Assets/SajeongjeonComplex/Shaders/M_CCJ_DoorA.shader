Shader "Unreal/M_CCJ_DoorA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_DoorA_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_DoorA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_DoorA_R", 2D ) = "white" {}
