Shader "Unreal/M_CCJ_PanelboardC"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Panelboard_C_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Panelboard_C_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Panelboard_C_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_CCJ_PanelboardC.hlsl"
