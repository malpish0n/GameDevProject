Shader "Unreal/M_CCJ_Door_Iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CCJ_Door_Iron_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_CCJ_Door_Iron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CCJ_Door_Iron_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_CCJ_Door_Iron_RN", 2D ) = "white" {}
