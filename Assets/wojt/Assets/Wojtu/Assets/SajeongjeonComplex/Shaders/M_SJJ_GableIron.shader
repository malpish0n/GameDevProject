Shader "Unreal/M_SJJ_GableIron"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_SJJ_GableIron_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_GableIron_R", 2D ) = "white" {}
