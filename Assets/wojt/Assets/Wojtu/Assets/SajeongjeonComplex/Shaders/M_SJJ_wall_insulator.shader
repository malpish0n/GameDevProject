Shader "Unreal/M_SJJ_wall_insulator"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SJJ_Wall_Insulator_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SJJ_Wall_Insulator_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_SJJ_Wall_Insulator_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_SJJ_wall_insulator.hlsl"
